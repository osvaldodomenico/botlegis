...
const DIVISAO_REGIONAL_OPCOES = ['ALTO TIETE','BRAGANTINA','CAPITAL','LITORAL NORTE','SAO JOSE DOS CAMPOS','SERRA DA MANTIQUEIRA','TAUBATE','VALE DA FÉ','VALE HISTORICO'];
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="stat-card">
            <p className="text-[13px] text-ink-muted uppercase tracking-wide">Total Territórios</p>
