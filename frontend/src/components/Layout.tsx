...
import { BarChart2, MapPin, LogOut, Menu, X, Map, Settings, FileBarChart, Activity, Shield } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/relatorios/raio-x', label: 'DNA da Campanha', icon: Activity },
  { href: '/sentinela', label: 'Sentinela', icon: Shield },
];
